...
export async function importLisbonFoodSources() {
  ...
  const lisbonFoodSources = [
    // Local Farms Direct Purchase
    {
      ...
      description: "One of Portugal's most well-known regenerative farms offering organic meats, vegetables, and pantry items delivered directly to Lisbon residents.",
    ...
    },
    {
      ...
      description: "Certified organic farm offering direct delivery of vegetable boxes, eggs, and seasonal items to the Lisbon area.",
    ...
    },
    {
      ...
      description: "Produces seasonal vegetables, herbs, and preserves. Available at Lisbon markets or by farm pickup with pre-order.",
    ...
    },
    {
      ...
      description: "A cooperative of organic farms delivering fresh seasonal produce directly to homes in Lisbon via box subscriptions.",
    ...
    },
    {
      ...
      description: "Family-run organic farm offering wine, olive oil, and seasonal produce for direct online order and Lisbon-area delivery.",
    ...
    },
    {
      ...
      description: "Provides local vegetable baskets sourced from sustainable farms, available via weekly subscription with Lisbon drop-off points.",
    ...
    {
      name: "Maria Granel",
      description: "Pioneering zero-waste store in Lisbon focused on bulk, organic goods where customers bring their own containers for all purchases.",
    ...
    {
      name: "Miosótis Bio",
      description: "Eco-conscious supermarket offering a range of plastic-free produce, dry goods in compostable or recyclable packaging, and refill stations.",
    ...
    {
      name: "Celeiro",
      description: "While not a zero-waste store, Celeiro offers some bulk items and reusable packaging products such as beeswax wraps and refillable jars.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Health Food Store",
      tags: ["low-waste", "reusable-options", "organic", "gluten-free", "vegan"],
      website: "https://www.celeiro.pt/",
    },
    {
      name: "Go Natural",
      description: "Provides natural and organic foods, with some bulk options and a section dedicated to sustainable household products.",
      address: "Av. da Liberdade, and other locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Health Food Store",
      tags: ["low-waste", "natural", "sustainable-packaging", "bulk", "organic"],
      website: "https://www.gonatural.pt/",
    },
    {
      name: "GreenBeans",
      description: "100% vegan and eco-focused store with minimal packaging, promoting biodegradable and reusable options.",
      address: "Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Vegan Grocery Store",
      tags: ["zero-waste", "vegan", "sustainable", "organic", "dairy-free"],
      website: "https://www.simbiotico.eco/en/ecospot/greenbeans",
    },
    {
      name: "Aromas do Valado",
      description: "Specializes in herbal teas, legumes, and spices sold in bulk or compostable packaging, with a zero-waste ethic.",
    ...
    {
      name: "Biomercado",
      description: "Carries a variety of bulk-packaged goods including flours, beans, and grains, all certified organic.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Organic Supermarket",
      tags: ["bulk", "organic", "zero-waste", "gluten-free", "vegan", "dairy-free"],
      website: "https://www.biomercado.pt/",
    },
    {
      name: "Lidl",
      description: "Though not a bulk store, Lidl regularly offers large value packs of grains, snacks, and frozen items at discount prices.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Supermarket",
      tags: ["bulk-value-packs", "budget-friendly", "gluten-free", "vegan", "dairy-free"],
      website: "https://www.lidl.pt/",
    },
    {
      name: "Auchan",
      description: "Provides a selection of dry goods and frozen items in bulk or extra-large formats, often with store-brand discounts.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Supermarket",
      tags: ["bulk-formats", "family-size", "gluten-free", "vegan", "dairy-free"],
    ...
    {
      name: "Continente",
      description: "Carries a wide selection of kid-friendly snacks including fruit bars, rice cakes, organic applesauce, and dairy-free yogurts.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Supermarket",
      tags: ["kid-friendly", "organic", "dairy-free", "gluten-free", "vegan", "fresh-vegetables"],
      website: "https://www.continente.pt/",
    },
    {
      name: "Pingo Doce",
      description: "Offers a variety of affordable healthy snack options for children such as dried fruits, fruit puree pouches, and non-sugar cereals.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Supermarket",
      tags: ["kid-friendly", "no-added-sugar", "budget-friendly", "gluten-free", "vegan", "dairy-free", "fresh-vegetables"],
    ...
    // No Processed Food Sources
    {
      ...
      description: "Traditional neighborhood market offering fresh produce, meats, and other naturally sourced goods with minimal processing.",
      address: "Rua Coelho da Rocha, 104",
      city: "Lisbon",
      country: "Portugal",
      category: "Traditional Market",
      tags: ["non-processed", "fresh", "traditional", "farm-raised-meat", "fresh-vegetables"],
      website: "https://www.mercadodecampodeourique.pt/",
    },
    {
      name: "Time Out Market Lisboa (Mercado da Ribeira)",
      description: "Public market with vendors selling fresh fruits, vegetables, and farm products directly from source with minimal handling.",
      address: "Avenida 24 de Julho",
      city: "Lisbon",
      country: "Portugal",
      category: "Market",
      tags: ["non-processed", "local-produce", "farm-raised-meat", "fresh-vegetables"],
    ...
    // Farm-Raised Meat
    {
      ...
      description: "Includes a gourmet meat section with select cuts from Portuguese farms known for humane and sustainable practices.",
      address: "Av. António Augusto de Aguiar, 31",
      city: "Lisbon",
      country: "Portugal",
      category: "Department Store with Supermarket",
      tags: ["farm-raised-meat", "premium", "regional", "gluten-free", "vegan", "dairy-free", "organic", "fresh-vegetables"],
    ...
    {
      name: "Bomercado",
      description: "Focuses on supporting local producers with organic certifications, offering fruits, vegetables, and pantry goods.",
    ...
    {
      name: "Minipreço",
      description: "Discount supermarket chain with multiple locations in Lisbon, offering some gluten-free options.",
      address: "Multiple locations in Lisbon",
      city: "Lisbon",
      country: "Portugal",
      category: "Supermarket",
