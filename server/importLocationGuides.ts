    ...
    try {
        ...
        const sintraPlaces = [
            // Gluten-Free stores in Sintra
            {
                ...
                description:
                    "Offers a variety of gluten-free products, including breads and pastas, under its in-house brand and international labels.",
            ...
            },
            {
                name: "Pingo Doce",
                description:
                    "Provides affordable gluten-free options such as cookies, crackers, and pasta in their health section.",
            ...
            },
            {
                name: "Auchan",
                description:
                    "Stocks certified gluten-free snacks, grains, and baking mixes with clearly labeled sections.",
            ...
            },
            {
                name: "Lidl",
                description:
                    "Offers gluten-free products under their 'Free From' and 'Bio Organic' brands, especially in cereals and snacks.",
                address: "Multiple Locations in Sintra",
                city: "Sintra",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                name: "Celeiro",
                description:
                    "Health food store with dedicated gluten-free shelves including cereals, pastas, and flours.",
            ...
            },
            {
                ...
                description:
                    "Small organic grocery shop offering gluten-free pantry items and fresh organic produce.",
            ...
            },
            {
                name: "Dookan",
                description:
                    "Indian grocery offering gluten-free flours and naturally gluten-free grains.",
            ...
            },
            {
                name: "Pisão Farm",
                description:
                    "Eco community farm where visitors can pick organic vegetables.",
            ...
            },
            {
                name: "Mercado Saloio",
                description:
                    "Local produce market offering a wide range of organic fruits and vegetables directly from local farmers.",
                ...
                tags: ["local-farms", "fresh-vegetables", "organic"],
                website:
                    "https://www.expatexchange.com/ctryguide/22868/92/Portugal/Living-in-Sintra-Best-Markets-in-Sintra",
            },
        ];
        ...
        const cascaisPlaces = [
            ...
            },
            {
                name: "Bioshop",
                description:
                    "Small organic store stocking some gluten-free foodstuffs and cosmetics.",
                ...
                website:
                    "https://www.happycow.net/reviews/bioshop-cascais-92393",
            },
            {
                name: "Mundo Bio Cascais",
                description:
                    "Organic market praised for its extensive selection of unique products.",
                address: "Cascais",
                city: "Cascais",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                ...
                description:
                    "Offers organic products from local producers, promoting sustainable local consumption.",
                address: "Cascais",
                city: "Cascais",
                country: "Portugal",
                category: "market",
                ...
                website:
                    "https://peggada.com/en/listing/agrobio-markets-cascais/",
            },
        ];
        ...
        const oeirasPlaces = [
            {
                name: "Continente",
                description:
                    "Offers a robust selection of gluten-free pastas, breads, and cereals under its in-house brand and international labels.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                name: "Pingo Doce",
                description:
                    "Affordable gluten-free options including cookies, crackers, and pasta in their health section.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                ...
                description:
                    "Premium gluten-free brands available, especially in their gourmet and import section.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                name: "Batarda's",
                description:
                    "Dedicated gluten-free bakery offering breads, cakes, and pastries.",
            ...
            },
            {
                name: "Miosótis",
                description:
                    "100% organic grocery store offering local and organic produce from partner farms.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "grocery",
            ...
            },
            {
                name: "Biocourela",
                description:
                    "Local organic grocery store offering certified organic products.",
            ...
            },
            {
                ...
                description:
                    "Organic farm that delivers fresh produce to Oeiras.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "market",
            ...
            },
            {
                name: "Semear",
                description:
                    "Local Oeiras-based organic social farm offering fresh produce.",
                address: "Oeiras",
                city: "Oeiras",
                country: "Portugal",
                category: "market",
            ...
            },
            {
                name: "DaQuinta",
                description:
                    "Fresh fruit and vegetable delivery boxes with organic options.",
        ...
        const insertedPlaces = await db
            .insert(places)
            .values(allPlacesWithStatus)
            .returning();

        console.log(
            `Successfully imported ${insertedPlaces.length} food sources across all locations`,
        );
