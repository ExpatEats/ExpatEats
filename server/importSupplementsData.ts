...
export async function importSupplementsData() {
  ...
  const supplementsData: InsertPlace[] = [
    ...
    {
      name: "Celeiro",
      description: "Portugal's leading natural products chain with a wide selection of supplements, vitamins, and herbal remedies.",
    ...
    },
    {
      ...
      description: "Offers a strong range of sports nutrition and wellness supplements in central Lisbon.",
      address: "Av. 5 de Outubro 293B, 1600-035 Lisboa",
      city: "Lisbon",
      country: "Portugal",
      category: "Health Food Store",
      tags: ["supplements", "sports-nutrition", "wellness"],
      website: "https://www.tripadvisor.com/Attraction_Review-g189158-d25642203-Reviews-PrimeBody-Lisbon_Lisbon_District"
    },
    {
      name: "El Corte Inglés",
      description: "Carries domestic and international supplement brands, including sports nutrition and specialty wellness products.",
      address: "Av. António Augusto de Aguiar 31, 1069-413 Lisboa",
      city: "Lisbon",
      country: "Portugal",
      category: "Department Store",
      tags: ["supplements", "sports-nutrition", "wellness", "international-brands"],
      website: "https://www.elcorteingles.pt"
    },
    {
      name: "Healthcare Store (Lisbon Airport)",
      description: "Focused on supplements and natural wellness, including travel-friendly formats.",
      address: "Lisbon Airport, Terminal 1",
      city: "Lisbon",
      country: "Portugal",
      category: "Health Food Store",
      tags: ["supplements", "natural-wellness", "travel-friendly"],
      website: "https://www.lisbonairport.pt/en/lis/services-shopping/shops-and-food/healthcare-store"
    },
    
    // Oeiras
    {
      name: "Celeiro (Oeiras Parque Shopping)",
      description: "Full range of natural health products and supplements, including vegan and gluten-free options.",
      address: "Av. António Bernardo Cabral de Macedo 19, 2770-219 Oeiras",
      city: "Oeiras",
      country: "Portugal",
      category: "Health Food Store",
    ...
    {
      name: "Natural Crave",
      description: "Smaller health store with a strong focus on supplements and clean ingredient lists.",
    ...
    // Cascais
    {
      ...
      description: "Offers certified supplements, herbal extracts, and wellness products.",
    ...
    {
      name: "Terra Pura",
      description: "Features natural supplements, superfoods, and essential oils in a well-curated environment.",
    ...
    {
      name: "Bioshop",
      description: "Small store in central Cascais with organic pantry goods and some natural supplements.",
    ...
    {
      name: "Mundo Bio",
      description: "Organic market in Cascais offering a wide range of supplements, wellness products, and clean-label groceries.",
    ...
    // Sintra
    {
      ...
      description: "Reliable stock of supplements, especially natural and allergy-friendly options.",
    ...
    },
    {
      ...
      description: "Offers locally made and bulk natural products, including select supplements.",
    ...
    {
      name: "Aldeia Coop",
      description: "Regenerative cooperative market offering supplements, bulk goods, and wellness products.",
      address: "Rua Marquês de Pombal 22, 2710-519 Sintra",
      city: "Sintra",
      country: "Portugal",
      category: "Cooperative Market",
      tags: ["supplements", "bulk", "wellness", "cooperative", "regenerative"],
    ...
    {
      name: "iHerb",
      description: "Comprehensive global retailer for supplements, with shipping to Portugal.",
    ...
    {
      name: "Prozis",
      description: "Portugal-based online store for fitness, wellness, and lifestyle supplements.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
    ...
    {
      name: "Welldium",
      description: "Practitioner-grade supplements from brands like Pure Encapsulations and Nordic Naturals.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
    ...
    },
    {
      ...
      description: "Renowned for high-purity omega-3 and DHA supplements.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
    ...
    },
    {
      ...
      description: "Specializes in hypoallergenic, vegan-friendly, and clinically backed supplements.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
      tags: ["supplements", "hypoallergenic", "vegan", "clinically-backed", "online"],
      website: "https://www.pureencapsulations.com"
    },
    {
      name: "Holland & Barrett",
      description: "Well-known retailer with a wide selection of global supplement brands.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
    ...
    {
      name: "Alnatura",
      description: "Organic product line including dietary supplements and nutritional aids.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
      tags: ["supplements", "organic", "dietary", "nutritional", "online"],
    ...
    {
      name: "Greatlife.eu",
      description: "European-based store with creatine, omega-3s, and essential minerals.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
    ...
    {
      name: "Nordic Kings",
      description: "Grass-fed and organic animal-based supplements like liver and bone broth.",
      address: "Online Store",
      city: "Online",
      country: "Portugal",
      category: "Online Store",
      tags: ["supplements", "grass-fed", "organic", "animal-based", "online"],
