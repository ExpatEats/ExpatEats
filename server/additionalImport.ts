  ...
  try {
    const additionalSources: InsertPlace[] = [
      ...
      // Add kid-friendly option
      {
        ...
        description: 'Specialty store focusing on healthy, organic, kid-friendly snacks and foods suitable for children with various dietary needs.',
    ...
    console.log(`Importing ${additionalSources.length} additional food sources...`);
