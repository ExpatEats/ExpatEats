    ...
    try {
        ...
        const dairyFreeFoodSources: FoodSourceData[] = [
            {
                name: "Continente",
                description:
                    "Continente offers a wide range of dairy-free products, including plant-based yogurts under its 'Powered by Plants' brand, featuring almond and coconut-based options.",
            ...
            },
            {
                name: "Pingo Doce",
                description:
                    "Pingo Doce provides various plant-based products, including non-dairy milks, yogurts, and ice creams.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
                category: "supermarket",
            ...
            },
            {
                name: "Lidl",
                description:
                    "Lidl offers a variety of dairy-free products, such as soy cream, non-dairy milks, and vegan ice creams.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
                category: "supermarket",
            ...
            },
            {
                name: "Auchan",
                description:
                    "Auchan stores provide a selection of dairy-free products, including vegan cheeses and plant-based alternatives.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
                category: "supermarket",
            ...
            },
            {
                ...
                description:
                    "El Corte Inglés includes a supermarket that stocks a variety of dairy-free and vegan products, catering to various dietary needs.",
            ...
            },
            {
                name: "Celeiro",
                description:
                    "Celeiro is a well-known health food chain offering a wide range of dairy-free products, including non-dairy milks and vegan items.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
            ...
            },
            {
                name: "Biomercado",
                description:
                    "Biomercado provides various dairy-free choices, including plant-based products and bulk ingredients.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
            ...
            },
            {
                name: "Maria Granel",
                description:
                    "Maria Granel offers a range of certified organic products, including lactose-free and vegan items, with a focus on reducing ecological footprint.",
                address: "Multiple locations in Lisbon",
                city: "Lisbon",
                country: "Portugal",
                category: "bulk store",
            ...
            },
            {
                ...
                imageUrl: "https://via.placeholder.com/150",
                website:
                    "https://www.happycow.net/reviews/bomercado-lisbon-424897",
            },
        ];
        ...
        const glutenFreeFoodSources: InsertPlace[] = [
            ...
            },
            {
                ...
                description:
                    "Neighborhood food market offering a variety of fresh produce and gourmet food stalls.",
            ...
            },
            {
                ...
                description:
                    "Hosts numerous vendors, some of which offer gluten-free options. Always ask about cross-contamination.",
        ...
        const freshVegetablesFoodSources: InsertPlace[] = [
            {
                name: "Mercado de Campo de Ourique",
                description:
                    "Historic food market offering a wide variety of fresh, seasonal vegetables from regional farmers.",
                address: "Rua Coelho da Rocha, 104",
                city: "Lisbon",
                country: "Portugal",
                category: "market",
            ...
            },
            {
                name: "Time Out Market Lisboa",
                description:
                    "Popular market with stalls selling fresh produce including vegetables directly from Portuguese growers.",
                address: "Avenida 24 de Julho",
                city: "Lisbon",
                country: "Portugal",
                category: "market",
        ...
        const addSourcesWithoutDuplicates = (sources: InsertPlace[]) => {
            sources.forEach((source) => {
                if (!uniquePlaceNames.has(source.name)) {
                    ...
                    const existingPlace = allFoodSources.find(
        ...
        allFoodSources.forEach((place) => {
            ...
            if (
                place.description.toLowerCase().includes("gluten-free") ||
            ...
            if (
                place.description.toLowerCase().includes("vegan") ||
            ...
            if (
                place.description.toLowerCase().includes("organic") ||
            ...
            if (
                place.description.toLowerCase().includes("fresh vegetables") ||
                place.description.toLowerCase().includes("produce") ||
                (place.tags &&
                    place.tags.some(
                        (tag) =>
                            tag.includes("fresh") || tag.includes("vegetables"),
                    ))
            ) {
            ...
            if (
                place.description.toLowerCase().includes("nut-free") ||
                (place.tags &&
                    place.tags.some((tag) => tag.includes("nut-free")))
            ) {
