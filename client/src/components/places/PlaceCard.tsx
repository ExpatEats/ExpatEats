...
const PlaceCard: React.FC<PlaceCardProps> = ({ place, onClick }) => {
    ...
    const useImageUrl =
        imageUrl && !imageUrl.includes("placeholder.com") ? imageUrl : null;
            ...
            <div className="relative h-48 w-full">
                <div className="absolute inset-0">
                    {useImageUrl && !imageError ? (
                        ...
                        <div
                            className={`w-full h-full bg-gradient-to-r ${getCategoryBg(category)} flex items-center justify-center`}
                        >
