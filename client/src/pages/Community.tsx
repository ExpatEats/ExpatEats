    ...
    const upcomingEvents = [
        {
            ...
            description:
                "Experience cuisines from around the world at this community-organized food festival.",
            date: "August 15, 2023",
        ...
        },
        {
            ...
            description:
                "Learn how to make authentic Thai dishes with Chef Niran. All ingredients provided.",
            date: "August 22, 2023",
        ...
        },
        {
            ...
            description:
                "Guided tour of the best spice shops and international markets in the city.",
            date: "August 28, 2023",
    ...
    const communityGroups = [
        {
            ...
            description:
                "A group for people who love Asian cuisine and want to share recipes, restaurant recommendations, and cooking tips.",
            members: 247,
        ...
        },
        {
            ...
            description:
                "Explore the healthy and delicious Mediterranean diet with fellow expats and locals.",
            members: 189,
        ...
        },
        {
            ...
            description:
                "Finding plant-based options abroad can be challenging. Connect with others to share tips and recommendations.",
            members: 156,
            ...
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg max-w-3xl mx-auto">
                        Connect with fellow expatriates who share your passion
                        for food. Attend events, join discussion groups, and
                ...
                <div className="bg-white rounded-xl card-shadow p-6 text-center">
                    ...
                    <p className="mb-6 text-gray-600 max-w-3xl mx-auto">
                        Contribute to our growing community by sharing your food
                        discoveries, recipes, and experiences living abroad.
                        Your knowledge helps other expats connect with the
                        tastes of home.
                    </p>
