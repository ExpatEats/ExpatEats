    ...
    <div className="container py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-3">{store.category}</p>
            ...
            {store.imageUrl ? (
              ...
              <div className="w-full md:w-64 h-48 bg-gradient-to-br from-[#E8F4F0] to-[#94AF9F] rounded-lg flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-sm font-medium">{store.category}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold mb-3">About This Store</h3>
              ...
              <div className="space-y-3">
                ...
                {store.createdAt && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Added to Expat Eats</p>
        ...
        <Card className="bg-[#E8F4F0] border-[#94AF9F]/20">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold mb-2 text-[#94AF9F]">Visit This Store</h3>
            <p className="text-gray-700">
              Use the address above to visit this location. For the most up-to-date hours and 
              contact information, we recommend calling ahead or checking their social media pages.
            </p>
          </CardContent>
        </Card>
      </div>
