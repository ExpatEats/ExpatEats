                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center p-3 bg-sage bg-opacity-10 rounded-full mb-6">
                            <Compass className="h-8 w-8 text-sage" />
                        </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <div className="inline-flex items-center gap-2 mb-4">
                                ...
                                <h2 className="font-cormorant text-3xl font-bold text-neutral-dark">
                                    Inside the Guide
                                </h2>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {guideFeatures.map((feature, index) => (
                                ...
                                >
                                    <CardContent className="pt-6">
                                        <div className="bg-sage bg-opacity-10 p-4 rounded-full w-14 h-14 mx-auto mb-4 flex items-center justify-center text-sage">
                                            {feature.icon}
                                        </div>
                                        <h3 className="font-cormorant font-semibold text-lg mb-2 text-center">
                                            {feature.title}
                                        </h3>
                                        <p className="text-t2 font-outfit text-sm text-center">
                                            {feature.description}
                                        </p>
                                    </CardContent>
                                </Card>
                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    {idealFor.map((item, index) => (
                                        ...
                                        >
                                            <Check className="text-sage mr-3 h-6 w-6 mt-0.5 flex-shrink-0" />
                            ...
                            <CardContent className="pt-8 pb-8">
                                <div className="text-center mb-8">
                                    <div className="flex items-center justify-center gap-3 mb-4">
                                        <Download className="h-10 w-10 text-sage" />
                                        <div>
                                            <p className="text-t2 font-outfit text-sm uppercase tracking-wide">
                                                One-Time Purchase
                                            </p>
