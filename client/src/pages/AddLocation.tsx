    ...
    <div className="container mx-auto py-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Add a Location</h1>
          <p className="text-gray-600">
            Help other expats by sharing a great food source or location you've discovered
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter information about a food source, market, or helpful location
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., Celeiro Dieta" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-3">Select all that apply to help others find this location</p>
                ...
                >
                  {addLocationMutation.isPending ? 'Adding Location...' : 'Add Location'}
                </Button>
              </form>
            </Form>
          </CardContent>
