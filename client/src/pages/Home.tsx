    ...
    <>
      ...
      <section className="relative py-12 md:py-24 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1551218808-94e220e084d2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080")' }}
        />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl mb-8 text-neutral-dark">
              Register to access our comprehensive guides to sustainable shopping in the Lisbon area and join our community of expats.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <h2 className="font-montserrat text-3xl font-bold mb-4 text-neutral-dark">Search With Your Eyes, Not Just Words</h2>
              <p className="mb-4 text-neutral-dark">Upload an image of food you're craving, and we'll find the closest match in your area. No more struggling to describe that special dish from home.</p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <Check className="text-[#5A8D3B] mr-2 h-5 w-5" />
                  <span>Find international ingredients by image</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-[#5A8D3B] mr-2 h-5 w-5" />
                  <span>Discover restaurants serving your favorite dishes</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-[#5A8D3B] mr-2 h-5 w-5" />
                  <span>Connect with others who share your food interests</span>
                </li>
              </ul>
              <Link href="/discover">
      ...
      <section className="py-12 bg-[#F9F5F0]">
        <div className="container mx-auto px-4">
          <h2 className="font-montserrat text-3xl font-bold mb-8 text-center text-neutral-dark">Find What You're Looking For</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {categories.map((category) => (
              <CategoryCard 
                key={category.id} 
                category={category} 
                onClick={() => window.location.href = `/discover?category=${category.name.toLowerCase()}`}
              />
            ))}
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2">
              <h2 className="font-montserrat text-3xl font-bold mb-4 text-neutral-dark">Join Our Community</h2>
              <p className="mb-6 text-neutral-dark">Register to access our comprehensive guides to sustainable shopping in the Lisbon area and join our community of expats.</p>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-montserrat font-semibold text-lg">Join Food Meetups</h3>
                    <p className="text-gray-600">Connect with others who share your culinary interests</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="bg-[#5A8D3B] bg-opacity-10 p-3 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" className="text-[#5A8D3B] h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-montserrat font-semibold text-lg">Share Tips & Recipes</h3>
                    <p className="text-gray-600">Exchange cooking advice and favorite recipes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-montserrat font-semibold text-lg">Contribute Locations</h3>
                    <p className="text-gray-600">Add your discoveries to help other expats</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-montserrat text-3xl font-bold mb-8 text-center text-neutral-dark">What Our Community Says</h2>
      ...
      <section className="py-16 bg-[#5A8D3B] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-montserrat text-3xl font-bold mb-4">Ready to Find Your Favorite Foods?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">Join thousands of expats who have discovered local sources for their favorite foods from back home.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/discover">
            ...
            <Link href="/nutrition">
              <Button variant="outline" className="border-2 border-white hover:bg-white hover:bg-opacity-10 text-white font-bold py-3 px-8 rounded-full text-lg transition w-full sm:w-auto">
                Learn More
              </Button>
            </Link>
          </div>
