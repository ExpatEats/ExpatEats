            ...
            <section className="relative py-12 md:py-24 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center p-3 bg-bark-lt bg-opacity-10 rounded-full mb-6">
                            <Star className="h-8 w-8 text-bark-lt" />
                        </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <Card className="shadow-lg hover:shadow-xl transition-shadow">
                                <CardContent className="pt-6">
                                    <div className="flex items-start gap-4">
                                        <div className="bg-sage bg-opacity-10 p-3 rounded-full flex-shrink-0">
                                ...
                                <CardContent className="pt-6">
                                    <div className="flex items-start gap-4">
                                        <div className="bg-bark-lt bg-opacity-10 p-3 rounded-full flex-shrink-0">
                                            <Home className="h-6 w-6 text-bark-lt" />
                                        </div>
                                        <div>
                                            <h3 className="font-cormorant font-semibold text-lg mb-2">
                                                Full Home Setup
                            ...
                            <Card className="shadow-lg hover:shadow-xl transition-shadow">
                                <CardContent className="pt-6">
                                    <div className="flex items-start gap-4">
                                        <div className="bg-bark-lt bg-opacity-10 p-3 rounded-full flex-shrink-0">
                                            <Map className="h-6 w-6 text-bark-lt" />
                                        </div>
                                        <div>
                                            <h3 className="font-cormorant font-semibold text-lg mb-2">
                        ...
                        <Card className="mt-6 shadow-lg bg-gradient-to-r from-[#94AF9F]/5 to-[#E07A5F]/5 border-2 border-[#E07A5F]">
                            <CardContent className="pt-6">
                                <div className="flex items-start gap-4">
                                    <div className="bg-bark-lt bg-opacity-10 p-3 rounded-full flex-shrink-0">
                                        <Gift className="h-6 w-6 text-bark-lt" />
                                    </div>
                                    <div>
                        ...
                        <Card className="shadow-lg">
                            <CardContent className="pt-6">
                                <div className="grid md:grid-cols-3 gap-6 text-center">
                                    ...
                                    <div>
                                        <div className="bg-bark-lt bg-opacity-10 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                                            <Star className="h-8 w-8 text-bark-lt" />
                                        </div>
                            ...
                            <CardContent className="pt-6">
                                <div className="flex items-start gap-4">
                                    <div className="bg-bark-lt bg-opacity-10 p-3 rounded-full">
                                        <Info className="h-6 w-6 text-bark-lt" />
                                    </div>
                                    <div>
                                        <h3 className="font-cormorant font-semibold text-lg mb-2 text-neutral-dark">
                                            Coming Soon
                    ...
                    <div className="max-w-2xl mx-auto">
                        <Card className="shadow-xl border-2 border-[#E07A5F] relative">
                            ...
                            <CardHeader className="text-center pb-4 pt-8">
                                ...
                                <p className="text-t2 font-outfit text-sm mb-6">
                                    Comprehensive arrival support tailored to your needs
                                </p>
                                <div className="flex items-center justify-center gap-2">
                                    <span className="text-t2 font-outfit text-lg">Starting at</span>
                                    <Euro className="h-10 w-10 text-bark-lt" />
                            ...
                            <CardContent>
                                <ul className="space-y-3 mb-8">
                                    ...
                                    <li className="flex items-start">
                                        <Check className="text-bark-lt mr-3 h-5 w-5 mt-0.5 flex-shrink-0" />
                                ...
                                <Button
                                    disabled={true}
                                    className="w-full py-6 text-lg font-semibold rounded-full bg-bark-lt text-white opacity-50 cursor-not-allowed"
                                >
                                    Coming Soon
                                </Button>

                                <p className="text-center text-t2 font-outfit mt-6 text-sm">
                        ...
                        <Card className="shadow-lg">
                            <CardContent className="pt-6">
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        <div className="bg-bark-lt text-white rounded-full w-10 h-10 flex items-center justify-center font-bold flex-shrink-0">
                                            1
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        <div className="bg-sage text-white rounded-full w-10 h-10 flex items-center justify-center font-bold flex-shrink-0">
                                            2
                                        </div>
                                        <div>
