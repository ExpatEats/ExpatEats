      ...
      <CardContent className="space-y-4 pb-3">
        ...
        <div className="flex flex-col space-y-2 text-sm">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span>{event.organizerName} · {event.organizerRole}</span>
          </div>
        </div>
      </CardContent>
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
          <div>
            <h1 className="font-montserrat text-3xl font-bold">Community Events</h1>
            <p className="text-gray-600 mt-2">Connect with other expats and learn about food in Lisbon</p>
          </div>
          <div className="flex items-center gap-4">
            <SubmissionForm 
              type="event" 
        ...
        {showAddEventForm && (
          <Card className="mb-8 shadow-md">
            <CardHeader className="bg-gray-50 border-b">
              <CardTitle className="text-xl">Add New Community Event</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
              <form onSubmit={handleSubmitEvent} className="space-y-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="infoLink" className="block text-sm font-medium">
        ...
        <div className="mt-10 text-center">
          <p className="text-lg font-medium text-gray-600 mb-4">Want to contribute to our community?</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/contact">
              <Button size="lg" className="bg-[#6D9075] hover:bg-[#6D9075]/90">
                Contact Us
              </Button>
            </Link>
          </div>
